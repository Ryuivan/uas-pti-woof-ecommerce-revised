      ...
      <form ref={form} onSubmit={sendEmail} autoComplete='off' className='text-center' id='send-feedback'>
        ...
        <div>
          <div className="mt-1 d-flex justify-content-center flex-column gap-15 align-items-center" >
            <button 
                className="btnFeedback border-2 px-3 mb-2 fw-light w-40 text-center text-decoration-none fs-5" 
                type="submit"
                value="send"
                style={{ height: '29px', borderRadius: "25px",}}
            >
              <p className='fw-light' style={{ fontSize: '16px', marginTop: '2px' }}>Submit</p>
            </button>
          </div>
        </div>
      </form>
